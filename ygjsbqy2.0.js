...
// @require      https://raw.githubusercontent.com/CallMeMaster/drcb-audit/master/jquery-drcb-common2.0.js
// ==/UserScript==
    ...
    var queryDetail=function(url,queryData,type){
        ...
        $.get(url,function(data){
            ...
            $.each(companys,function(i,company){
                ...
                var name = $(company).find("a.ma_h1").text();
